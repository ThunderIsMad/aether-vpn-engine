...
|-------------|----------|--------|
| HNDL-safe (записи сессии) | гибрид **внутри Clatter**: DH- и KEM-секреты сходятся в его chaining key (наш HKDF от `get_chaining_key()`, Q10); комбинат не сверяем нашим кодом — Phase 0.5 (Q12) | ПРОЕКТНО, примитивы стандартны |
