...
description: Drive one roadmap phase end-to-end — read the phase, scaffold, implement module by module, run tests, update roadmap checkboxes, write a phase report. Use when starting a new phase from design/05-roadmap.md.
metadata:
...
1. Read design/05-roadmap.md phase items + design/03-components.md module specs for those items.
...
6. Update design/05-roadmap.md checkboxes [x] and append a phase report to docs/phase-reports/:
